    ...
    <div class="row main-part">
        ...
        <div class="col-sm-8 middle-div">
            <div class="form-component container shadow-lg m-3 h-100 w-100">
                ...
                <div class="row">
                    <div class="mx-auto">
                        <button id="add-button" type="button" class="btn btn-outline-primary rounded-circle">Add
                        </button>
                    </div>
                    ...
                    <div class="mx-auto">
                        <button id="update-button" type="button" class="btn btn-outline-primary rounded-circle">Update
                        </button>
                    </div>
                </div>
